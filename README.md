...
+ Время которое тела были в контакте при ударе тоже можно рассчитать

![download](https://user-images.githubusercontent.com/52743561/165100161-360a896d-11d1-434c-af8e-9f4b45e9b26b.gif)

Если c — скорость звука в теле, L — характерный размер каждого тела, то время удара будет порядка t=2L/c — двукратному прохождению волны деформации вдоль линии соударения.
